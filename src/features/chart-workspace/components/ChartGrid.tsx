...
export const ChartGrid: React.FC<ChartGridProps> = (props) => {
  ...
  switch (layoutType) {
    ...
    case '2v': {
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-row h-full w-full bg-[#131722] p-1.5 gap-0">
          <div style={{ width: `${sizes[0]}%` }} className="h-full">
            {renderSlot(0)}
          </div>
          <div
          ...
          />
          <div style={{ width: `${sizes[1]}%` }} className="h-full">
            {renderSlot(1)}
          </div>
        </div>
      );
    ...
    case '2h': {
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-col h-full w-full bg-[#131722] p-1.5 gap-0">
          <div style={{ height: `${sizes[0]}%` }} className="w-full">
            {renderSlot(0)}
          </div>
          <div
          ...
          />
          <div style={{ height: `${sizes[1]}%` }} className="w-full">
            {renderSlot(1)}
          </div>
        </div>
      );
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-row h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          <div
            ...
            className="w-1.5 h-full cursor-col-resize hover:bg-indigo-500/50 bg-gray-900 border-l border-r border-gray-800 transition-colors z-20 flex-shrink-0"
          />
          <div style={{ width: `${sizes[2]}%` }} className="h-full">
            {renderSlot(2)}
          </div>
        </div>
      );
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-col h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          <div
            ...
            className="h-1.5 w-full cursor-row-resize hover:bg-indigo-500/50 bg-gray-900 border-t border-b border-gray-800 transition-colors z-20 flex-shrink-0"
          />
          <div style={{ height: `${sizes[2]}%` }} className="w-full">
            {renderSlot(2)}
          </div>
        </div>
      );
    ...
    case '3g1': {
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-row h-full w-full bg-[#131722] p-1.5 gap-0">
          <div style={{ width: `${mainSizes[0]}%` }} className="h-full">
            {renderSlot(0)}
          </div>
          <div
          ...
          >
            <div style={{ height: `${subSizes[0]}%` }} className="w-full">
              {renderSlot(1)}
            </div>
            <div
              ...
              className="h-1.5 w-full cursor-row-resize hover:bg-indigo-500/50 bg-gray-900 border-t border-b border-gray-800 transition-colors z-20 flex-shrink-0"
            />
            <div style={{ height: `${subSizes[1]}%` }} className="w-full">
              {renderSlot(2)}
            </div>
          </div>
        </div>
    ...
    case '3g2': {
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-col h-full w-full bg-[#131722] p-1.5 gap-0">
          <div style={{ height: `${mainSizes[0]}%` }} className="w-full">
            {renderSlot(0)}
          </div>
          <div
          ...
          >
            <div style={{ width: `${subSizes[0]}%` }} className="h-full">
              {renderSlot(1)}
            </div>
            <div
              ...
              className="w-1.5 h-full cursor-col-resize hover:bg-indigo-500/50 bg-gray-900 border-l border-r border-gray-800 transition-colors z-20 flex-shrink-0"
            />
            <div style={{ width: `${subSizes[1]}%` }} className="h-full">
              {renderSlot(2)}
            </div>
          </div>
        </div>
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-row h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          <div
            ...
            className="w-1.5 h-full cursor-col-resize hover:bg-indigo-500/50 bg-gray-900 border-l border-r border-gray-800 transition-colors z-20 flex-shrink-0"
          />
          <div style={{ width: `${mainSizes[1]}%` }} className="h-full">
            {renderSlot(2)}
          </div>
        </div>
      );
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-col h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          <div
            ...
            className="h-1.5 w-full cursor-row-resize hover:bg-indigo-500/50 bg-gray-900 border-t border-b border-gray-800 transition-colors z-20 flex-shrink-0"
          />
          <div style={{ height: `${mainSizes[1]}%` }} className="w-full">
            {renderSlot(2)}
          </div>
        </div>
      );
    ...
    case '4g': {
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-col h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          >
            <div style={{ width: `${sub1Sizes[0]}%` }} className="h-full">
              {renderSlot(0)}
            </div>
            <div
              ...
              className="w-1.5 h-full cursor-col-resize hover:bg-indigo-500/50 bg-gray-900 border-l border-r border-gray-800 transition-colors z-20 flex-shrink-0"
            />
            <div style={{ width: `${sub1Sizes[1]}%` }} className="h-full">
              {renderSlot(1)}
            </div>
          </div>
          <div
          ...
          >
            <div style={{ width: `${sub2Sizes[0]}%` }} className="h-full">
              {renderSlot(2)}
            </div>
            <div
              ...
              className="w-1.5 h-full cursor-col-resize hover:bg-indigo-500/50 bg-gray-900 border-l border-r border-gray-800 transition-colors z-20 flex-shrink-0"
            />
            <div style={{ width: `${sub2Sizes[1]}%` }} className="h-full">
              {renderSlot(3)}
            </div>
          </div>
        </div>
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-row h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          <div
            ...
            className="w-1.5 h-full cursor-col-resize hover:bg-indigo-500/50 bg-gray-900 border-l border-r border-gray-800 transition-colors z-20 flex-shrink-0"
          />
          <div style={{ width: `${sizes[3]}%` }} className="h-full">
            {renderSlot(3)}
          </div>
        </div>
      );
      ...
      return (
        <div ref={layoutContainerRef} className="flex flex-col h-full w-full bg-[#131722] p-1.5 gap-0">
          ...
          <div
            ...
            className="h-1.5 w-full cursor-row-resize hover:bg-indigo-500/50 bg-gray-900 border-t border-b border-gray-800 transition-colors z-20 flex-shrink-0"
          />
          <div style={{ height: `${sizes[3]}%` }} className="w-full">
            {renderSlot(3)}
          </div>
        </div>
      );
